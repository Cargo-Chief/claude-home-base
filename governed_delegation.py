...
# at 20,000 each, a second generated task at 20,000, the verifier at 30,000 and
# the omission pass at 25,000 — 225,000 — plus the 50,000 owner reserve, so
# 275,000. The former 250,000 was picked before any stage had been metered and
# sat below that, which is what made it brittle; 400,000 leaves real headroom
# above a correctly-sized roster instead of landing exactly on it.
